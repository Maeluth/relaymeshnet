# L3: Content-Addressed Storage 🟡 Required

> **Required.** Без контентного слоя нет обмена файлами, нет репликации, нет зеркалирования сервисов. Сеть работает, но только текст. Без этого — не интернет, а пейджер.
